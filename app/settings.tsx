    ...
    <View className="h-full bg-white">
      ...
      <View className="bg-white -mt-12 rounded-t-3xl border-2 border-gray-200 p-4 shadow-3xl h-5/6">
        ...
        <View className="flex-row justify-between items-center">
          <AppText className="text-lg font-semibold">Emergency Number</AppText>
          <TouchableOpacity
        ...
        {/* Personal Details */}
        <View className="flex-row justify-between items-center">
          <AppText className="text-lg font-semibold">Personal Details</AppText>
          <TouchableOpacity
        ...
        {/* Policies */}
        <AppText className="text-lg mt-4 font-semibold">Privacy Policy</AppText>
